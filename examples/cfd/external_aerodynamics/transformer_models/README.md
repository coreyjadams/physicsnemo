...
The training script supports data-parallel training via PyTorch DDP. In a future update, we may enable domain parallelism via ShardTensor (with DDP or FSDP2 `fully_shard` on the data-parallel axis).
