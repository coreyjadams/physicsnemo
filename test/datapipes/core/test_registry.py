...
class TestGlobalRegistry:
    """Tests for the global COMPONENT_REGISTRY."""
...
class TestOmegaConfResolver:
    """Tests for the OmegaConf resolver integration."""

    def test_resolve_transform(self):
    ...
    def test_omegaconf_resolver_with_reader(self):
        ...
        resolved = OmegaConf.to_container(cfg, resolve=True)
        assert (
            resolved["_target_"] == "physicsnemo.datapipes.core.readers.zarr.ZarrReader"
        )
...
class TestHydraInstantiation:
    """Tests for instantiating components via Hydra."""

    def test_instantiate_normalize(self):
    ...
    def test_instantiate_subsample_points(self):
    ...
    def test_instantiate_compose(self):
    ...
    def test_instantiate_center_of_mass(self):
    ...
    def test_instantiate_rename(self):
    ...
    def test_instantiate_purge(self):
    ...
    def test_instantiate_concat_fields(self):
    ...
    def test_instantiate_field_slice(self):
    ...
    def test_instantiate_constant_field(self):
    ...
    def test_instantiate_bounding_box_filter(self):
...
class TestHydraEndToEnd:
    """End-to-end tests for Hydra instantiation with actual data."""

    def test_normalize_from_hydra_applies_correctly(self):
    ...
    def test_subsample_from_hydra_applies_correctly(self):
    ...
    def test_compose_pipeline_from_hydra(self):
...
class TestRegisterDecorator:
    """Tests for the register decorator convenience function."""

    def test_register_adds_to_global_registry(self):
